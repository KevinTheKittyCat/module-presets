...
function checkIfSettingsExists() {
    ...
    if (setting !== undefined) {
        ...
        const stringified = ""//"No Modules"// JSON.stringify(content)
        game.settings.set("modulePresets", "presets", {modules:[{ title: "No Modules", content: {}, stringified }]})
