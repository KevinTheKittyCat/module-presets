...
window.makePreset = async () => {
    ...
    let name = await new Promise((resolve, reject) => {
        let form = new MyFormApplication(naaaame, {
            popOut: true,
            width: "400px",
        ...
        const formName = $(document.body).on("submit", "#myForm", function () {
    ...
    const newPreset = [{ title: nameTest, content: { modules }, stringified }]
