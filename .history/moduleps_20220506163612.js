...
Hooks.once('ready', () => {
    ...
    Handlebars.registerHelper('selectPreset', function (content) {
        console.log(this)
    ...
    Handlebars.registerHelper('makePreset', function (value) {
        console.log($(this))
        console.log($("#presetAddButton"))
        Hooks.once("renderApplication", application => {
            console.log(application)
            if (application.title === "Preset List") {
                $("presetAddButton").on("submit", event => {
                    console.log("GORT ")
